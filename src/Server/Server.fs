...
module Storage =
    ...
    let initialize = async {
        ...
        MHWGameDataLoader.Decoration.loadDecorations () |> ignore
        MHWGameDataLoader.SkillLevel.loadSkillLevels () |> ignore
        MHWGameDataLoader.SetSkillLevel.loadSetSkillLevels () |> ignore
